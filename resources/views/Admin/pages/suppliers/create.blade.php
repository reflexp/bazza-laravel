                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Добавление поставщика</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="createSupplyForm">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Введите наименование">
                              </div>
                            <div class="form-group col-md-6">
                              ...
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="exchange" step="0.01" placeholder="Пример - 5,65" value="5.65">
                              </div>
                              <div class="form-row">
                                <div class="form-group col-md-6">
                                  <label for="increaseType">Тип наценки</label>
                                  <select name="increaseType" class="form-control">
                                    <option value="0" selected>Наценка</option>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <select name="taxType" class="form-control">
                                    <option value="0" selected>Упрощенка</option>
                              ...
                              <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="yurinfo" placeholder="Введите юридическую информацию" rows="8" maxlength="2048"></textarea>
...
@section('scripts')
    <script>
        window.addEventListener('load', () => {
          ...
          // Создание
          jQuery(document).on('submit', '#createSupplyForm', function(e) {
            e.preventDefault();
            ...
            const response = apiRequest('addSupplier', formData);
