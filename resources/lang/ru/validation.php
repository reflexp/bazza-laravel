...
<<<<<<< HEAD
        ...
        'comment'                    => 'Комментарий',
        'commonTax'                  => 'Налог',
        'shopRules'                  => 'Правила пользования магазином',
        'deliveryType'               => 'Тип доставки',
        'deliveryAddressInCity'      => 'Адрес доставки в городе',
        'email'                      => 'Почта',
        'exchange'                   => 'Курс',
        'file'                       => 'файл',
        'increaseIncome'             => 'Наценка прибыли',
        'increaseDelivery'           => 'Наценка доставки',
        'increaseRetail'             => 'Наценка розничной продажи',
        'increaseWholesale'          => 'Наценка оптовой продажи',
        'increaseBigWholesale'       => 'Наценка крупнооптовой продажи',
        'increaseType'               => 'Тип наценки',
        'login'                      => 'Логин',
        'manufacturer'               => 'Производитель',
        'name'                       => 'Имя',
        'newPassword'                => 'Новый пароль',
        'newPasswordRepeated'        => 'Повторенный новый пароль',
        ...
        'title'                      => 'Наименование',
        'yurinfo'                    => 'Юридическая информация',
=======
        'address' => 'адрес',
        'buyerType' => 'тип покупателя',
        'city' => 'город',
        ...
        'title' => 'наименование',
        'yurinfo' => 'юридическая информация',
>>>>>>> be637bb (Добавил функционал множественного привязывания складов к менеджеру по складам)
    ],
